...
{
    g_log_filename = (char *)malloc(LOG_MAX_FILENAME_SIZE*sizeof(char));
    ...
    if (date_style == ddmmyyyy)
        snprintf(g_log_filename, sizeof(g_log_filename), log_filename_fmt, time_info->tm_mday, time_info->tm_mon,
                 1900+time_info->tm_year, time_info->tm_hour, time_info->tm_min, time_info->tm_sec);
    else if (date_style == mmddyyyy)
        snprintf(g_log_filename, sizeof(g_log_filename), log_filename_fmt, time_info->tm_mon, time_info->tm_mday,
                 1900+time_info->tm_year, time_info->tm_hour, time_info->tm_min, time_info->tm_sec);
